...
unsigned int sweep2(struct client_states** last_active,struct client_states** sublast_active)
{
    struct file_list *fl, *nfl;
    struct client_state *csp;
...
#endif /* def FEATURE_TRUST */
    printf("\nVPN log any_loaded_file_changed return FALSE");
   return FALSE;
}
